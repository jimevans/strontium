...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.FindChildElement"/> command.
    /// </summary>
    internal class FindChildElementHandler : WebElementCommandHandler
    {
        private string mechanism;
        private string findValue;

        /// <summary>
        /// Initializes a new instance of the <see cref="FindChildElementHandler"/> class.
        /// </summary>
        ...
        public FindChildElementHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[find child element of: {0} by: {1}='{2}']", ElementId, mechanism, findValue);
        }

        /// <summary>
        /// Finds a child element of the element associated with this <see cref="CommandHandler"/> meeting the specified criteria.
        /// </summary>
        ...
        internal override object Execute()
        {
            ...
            IWebElement childElement = parentElement.FindElement(finder);
