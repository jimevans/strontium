// <copyright file="GetCurrentUrlHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GetCurrentUrl"/> command.
    /// </summary>
    internal class GetCurrentUrlHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentUrlHandler"/> class.
        /// </summary>
        ...
        public GetCurrentUrlHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
