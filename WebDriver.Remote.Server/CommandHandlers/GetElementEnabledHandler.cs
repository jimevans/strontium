// <copyright file="GetElementEnabledHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.IsElementEnabled"/> command.
    /// </summary>
    internal class GetElementEnabledHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetElementEnabledHandler"/> class.
        /// </summary>
        ...
        public GetElementEnabledHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[get element enabled: {0}]", this.ElementId);
        }
