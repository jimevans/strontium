// <copyright file="ClickElementHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.ClickElement"/> command.
    /// </summary>
    internal class ClickElementHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClickElementHandler"/> class.
        /// </summary>
        ...
        public ClickElementHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[click: {0}]", this.ElementId);
        }
