// <copyright file="GetElementTagNameHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GetElementTagName"/> command.
    /// </summary>
    internal class GetElementTagNameHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetElementTagNameHandler"/> class.
        /// </summary>
        ...
        public GetElementTagNameHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[get element tag name: {0}]", this.ElementId);
        }
