// <copyright file="ScreenshotHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.Screenshot"/> command.
    /// </summary>
    internal class ScreenshotHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotHandler"/> class.
        /// </summary>
        ...
        public ScreenshotHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        public override object Execute()
        {
            ...
            {
                throw new InvalidCommandException("Driver does not support taking screenshots");
            }

            Screenshot currentScreenshot = screenshotDriver.GetScreenshot();
            return currentScreenshot.AsBase64EncodedString;
        }
    }
}
