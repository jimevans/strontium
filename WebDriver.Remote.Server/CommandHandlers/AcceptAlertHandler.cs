// <copyright file="AcceptAlertHandler.cs" company="WebDriver Committers">
//
...
namespace OpenQA.Selenium.Remote.Server.CommandHandlers
{
    ...
    /// </summary>
    internal class AcceptAlertHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptAlertHandler"/> class.
        /// </summary>
        ...
        public AcceptAlertHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[accept alert]");
        }
