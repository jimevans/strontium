// <copyright file="FindElementHandler.cs" company="WebDriver Committers">
...
namespace OpenQA.Selenium.Remote.Server.CommandHandlers
{
    ...
    internal class FindElementHandler : WebDriverCommandHandler
    {
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[find element by: {0}='{1}']", this.mechanism, this.findValue);
        }
