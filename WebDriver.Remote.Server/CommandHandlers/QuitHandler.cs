// <copyright file="QuitHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.Quit"/> command.
    /// </summary>
    internal class QuitHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuitHandler"/> class.
        /// </summary>
        ...
        public QuitHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
