// <copyright file="GetOrientationHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GetOrientation"/> command.
    /// </summary>
    internal class GetOrientationHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrientationHandler"/> class.
        /// </summary>
        ...
        public GetOrientationHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[get orientation]");
        }
