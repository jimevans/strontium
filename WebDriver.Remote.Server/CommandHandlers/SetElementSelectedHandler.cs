...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.SetElementSelected"/> command.
    /// </summary>
    internal class SetElementSelectedHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetElementSelectedHandler"/> class.
        /// </summary>
        ...
        public SetElementSelectedHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[set element selected: {0}]", ElementId);
        }

        /// <summary>
        /// Selects the element referenced by this <see cref="CommandHandler"/>.
        /// </summary>
