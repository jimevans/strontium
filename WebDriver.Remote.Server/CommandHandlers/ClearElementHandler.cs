// <copyright file="ClearElementHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.ClearElement"/> command.
    /// </summary>
    internal class ClearElementHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearElementHandler"/> class.
        /// </summary>
        ...
        public ClearElementHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[clear: {0}]", this.ElementId);
        }

        /// <summary>
        /// Clears the element associated with this <see cref="CommandHandler"/>.
        /// </summary>
