...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GetSpeed"/> command.
    /// </summary>
    internal class GetSpeedHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSpeedHandler"/> class.
        /// </summary>
        ...
        public GetSpeedHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return "[get driver speed]";
        }

        /// <summary>
        /// Gets the mouse speed of the current driver session.
        /// </summary>
