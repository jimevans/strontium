...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.DragElement"/> command.
    /// </summary>
    internal class DragElementHandler : WebElementCommandHandler
    {
        private int x;
        private int y;

        /// <summary>
        /// Initializes a new instance of the <see cref="DragElementHandler"/> class.
        /// </summary>
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[drag element: {0} by (x, y): {1}, {2}]", ElementId, x, y);
        }
