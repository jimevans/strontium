// <copyright file="SwitchToWindowHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.SwitchToWindow"/> command.
    /// </summary>
    internal class SwitchToWindowHandler : WebDriverCommandHandler
    {
        private string windowName;

        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchToWindowHandler"/> class.
        /// </summary>
        ...
        {
            this.windowName = GetCommandParameter("name").ToString();
        }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[switch to window: {0}]", this.windowName);
        }
        ...
        {
            Session.Driver.SwitchTo().Window(this.windowName);
            return null;
        }
    }
}
