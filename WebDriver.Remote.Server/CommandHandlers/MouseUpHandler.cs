// <copyright file="MouseUpHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.MouseUp"/> command.
    /// </summary>
    internal class MouseUpHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MouseUpHandler"/> class.
        /// </summary>
        ...
        public MouseUpHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
