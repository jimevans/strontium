// <copyright file="GoBackHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GoBack"/> command.
    /// </summary>
    internal class GoBackHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GoBackHandler"/> class.
        /// </summary>
        ...
        public GoBackHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
