...
namespace OpenQA.Selenium.Remote.Server
{
    ...
    internal class DriverFactory
    {
        ...
        {
            knownDrivers.Add(capabilities, driverClass);
        }
        ...
        {
            Type driverType = GetBestMatchForCapabilities(capabilities);
        ...
        private Type GetBestMatchForCapabilities(ICapabilities desired)
        {
            ...
            foreach (ICapabilities entry in knownDrivers.Keys)
            {
                int count = 0;
                ...
                {
                    if (capPlatform.IsPlatformType(desiredPlatform.Type))
                    {
                        count++;
                    }
                }
