...
namespace OpenQA.Selenium.Remote.Server.CommandHandlers
{
    ...
    internal class GetSessionCapabilitiesHandler : WebDriverCommandHandler
    {
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[get session capabilities: {0}]", SessionId);
        }
        ...
        public override object Execute()
        {
            ...
            capabilitesDictionary.Add("platform", capabilities.Platform.Type.ToString().ToUpperInvariant());
