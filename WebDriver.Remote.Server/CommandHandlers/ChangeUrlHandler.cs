// <copyright file="ChangeUrlHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.Get"/> command.
    /// </summary>
    internal class ChangeUrlHandler : WebDriverCommandHandler
    {
        private string targetUrl;

        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeUrlHandler"/> class.
        /// </summary>
        ...
        public ChangeUrlHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
            : base(locatorParameters, parameters)
        {
            this.targetUrl = GetCommandParameter("url").ToString();
        }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[get: {0}]", this.targetUrl);
        }
        ...
        {
            Session.Driver.Url = this.targetUrl;
            return null;
        }
    }
}
