// <copyright file="SetWindowPositionHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.SetWindowPosition"/> command.
    /// </summary>
    internal class SetWindowPositionHandler : WebDriverCommandHandler
    {
        private Point windowPosition;

        /// <summary>
        /// Initializes a new instance of the <see cref="SetWindowPositionHandler"/> class.
        /// </summary>
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[set window position: {0}, {1}]", this.windowPosition.X, this.windowPosition.Y);
        }

        /// <summary>
        /// Sets the position of the window for the current driver.
        /// </summary>
