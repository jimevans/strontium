// <copyright file="GoForwardHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GoForward"/> command.
    /// </summary>
    internal class GoForwardHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GoForwardHandler"/> class.
        /// </summary>
        ...
        public GoForwardHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
