// <copyright file="FindElementsHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.FindElements"/> command.
    /// </summary>
    internal class FindElementsHandler : WebDriverCommandHandler
    {
        private string mechanism;
        private string findValue;

        /// <summary>
        /// Initializes a new instance of the <see cref="FindElementsHandler"/> class.
        /// </summary>
        ...
        public FindElementsHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[find elements by: {0}='{1}']", this.mechanism, this.findValue);
        }
        ...
        public override object Execute()
        {
            ...
            ReadOnlyCollection<IWebElement> childElements = Session.Driver.FindElements(finder);
