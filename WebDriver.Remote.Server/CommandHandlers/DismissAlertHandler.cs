// <copyright file="DismissAlertHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.DismissAlert"/> command.
    /// </summary>
    internal class DismissAlertHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DismissAlertHandler"/> class.
        /// </summary>
        ...
        public DismissAlertHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[dismiss alert]");
        }
