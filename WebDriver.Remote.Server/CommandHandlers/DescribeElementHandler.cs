// <copyright file="DescribeElementHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.DescribeElement"/> command.
    /// </summary>
    internal class DescribeElementHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DescribeElementHandler"/> class.
        /// </summary>
        ...
        public DescribeElementHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
