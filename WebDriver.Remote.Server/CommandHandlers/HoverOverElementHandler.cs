...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.HoverOverElement"/> command.
    /// </summary>
    internal class HoverOverElementHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HoverOverElementHandler"/> class.
        /// </summary>
        ...
        public HoverOverElementHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[hover: {0}]", ElementId);
        }
