// <copyright file="SubmitElementHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.SubmitElement"/> command.
    /// </summary>
    internal class SubmitElementHandler : WebElementCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmitElementHandler"/> class.
        /// </summary>
        ...
        public SubmitElementHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        /// <summary>
        /// Submits the element referenced by this <see cref="CommandHandler"/>.
        /// </summary>
