// <copyright file="GetAlertTextHandler.cs" company="WebDriver Committers">
//
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.GetAlertText"/> command.
    /// </summary>
    internal class GetAlertTextHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlertTextHandler"/> class.
        /// </summary>
        ...
        public GetAlertTextHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[get alert text]");
        }

        /// <summary>
        /// Gets the text of the currently displayed IAlert.
        /// </summary>
        /// <returns>The text of the alert.</returns>
        public override object Execute()
        {
            return Session.Driver.SwitchTo().Alert().Text;
        }
    }
}
