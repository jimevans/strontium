// <copyright file="MouseDownHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.MouseDown"/> command.
    /// </summary>
    internal class MouseDownHandler : WebDriverCommandHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MouseDownHandler"/> class.
        /// </summary>
        ...
        public MouseDownHandler(Dictionary<string, string> locatorParameters, Dictionary<string, object> parameters)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[left mouse button down]");
        }
