// <copyright file="DeleteCookieNamedHandler.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Provides the handler for the <see cref="DriverCommand.DeleteCookie"/> command.
    /// </summary>
    internal class DeleteCookieNamedHandler : WebDriverCommandHandler
    {
        private string name = string.Empty;

        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCookieNamedHandler"/> class.
        /// </summary>
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "[delete cookie: {0}]", this.name);
        }
        ...
        {
            Session.Driver.Manage().Cookies.DeleteCookieNamed(this.name);
            return null;
        }
    }
}
